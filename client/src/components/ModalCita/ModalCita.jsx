        ...
        >
            ...
            <Form className="form-create-appoinment mb-5">
              <div className="separate">
                <Form.Group className="mb-3 hour">
                  ...
                  {valErrors.start_date && (
                    <p className="error">{valErrors.start_date}</p>
                  )}
                </Form.Group>
                <Form.Group className="mb-3 hour">
              ...
              <div className="separate">
                <Form.Group className="mb-3 hour">
                  ...
                  <Form.Control
                    ...
                    type="time"
                  />
                  {valErrors.start_hour && (
                    <p className="error">{valErrors.start_hour}</p>
                  )}
                </Form.Group>
                <Form.Group className="mb-3 hour">
                  ...
                  />
                  {valErrors.end_hour && (
                    <p className="error">{valErrors.end_hour}</p>
                  )}
                </Form.Group>
              </div>
              <Form.Group className="mb-3">
                ...
                <Form.Control
                  ...
                  readOnly
                />
                {valErrors.client_name && (
                  <p className="error">{valErrors.client_name}</p>
                )}
              </Form.Group>
              <Form.Group className="mb-3">
              ...
              <Form.Group>
                ...
                <Form.Select
                  ...
                  value={editData?.employee_user_id || ''}
                  onChange={handleChange}
                >
                ...
                {valErrors.employee_user_id && (
                  <p className="error">{valErrors.employee_user_id}</p>
                )}
              </Form.Group>
              <Form.Group>
              ...
              <Form.Group className="mb-3">
                ...
                <Form.Control
                  ...
                  readOnly
                />
                {valErrors.client_phone && (
                  <p className="error">{valErrors.client_phone}</p>
                )}
              </Form.Group>
              <Form.Group className="mb-3">
                ...
                <Form.Control
                  ...
                  as="textarea"
                />
                {valErrors.observation && (
                  <p className="error">{valErrors.observation}</p>
                )}
              </Form.Group>
              <Form.Group>
                ...
                {valErrors.status && (
                  <p className="error">{valErrors.status}</p>
                )}
              </Form.Group>
          ...
          <Modal.Footer className="background justify-content-center">
            <div className="botones d-flex justify-content-between w-100">
              <button type="button" onClick={cancelAppointment} className="btn">
                Cancelar cita
              </button>
              <div>
                <button
